...
import image from '../../assets/Banner/banner-02.jpg';
  ...
  return (
    <div className="relative mb-16 md:mb-24">
      ...
      <div className="absolute text-start flex justify-start transform -translate-y-36 md:-translate-y-1/2 left-6 md:left-6 lg:left-16 top-44 md:top-20 lg:top-32">
        <h2 className="text-3xl md:text-3xl lg:text-5xl w-[100%] md:w-[100%] lg:w-[100%] font-semibold text-[#081D03] leading-none">
